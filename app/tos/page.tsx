...
export default function TermsOfServicePage() {
  return (
    <>
      ...
      <p>
        Welcome to The ID Game (&quot;game&quot;, &quot;Service&quot;), operated
        by g30r93g.dev (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;). By
      ...
      <ul className={"list-disc ml-8"}>
        ...
        <li>
          must not attempt to disrupt, exploit, or gain unauthorised access to,
          nor interfere with the programming of the Game.
        </li>
      </ul>
      <p>
        We reserve the right to suspend or terminate accounts should we suspect
      ...
      <p>
        We use 3rd parties to provide the Service and enable the functionality
        provided.
      </p>
      <ul className={"list-disc ml-8"}>
      ...
      <p>
        The content you submit to the Service is owned by you, the end user.
      </p>
      <p>
        By submitting content, you grant us a non-exclusive, worldwide,
        royalty-free license to use, store, and display your content as
